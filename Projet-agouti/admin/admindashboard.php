...
if (strlen($_SESSION['alogin']) == 0) {
  ...
  header('location:../adminlogin.php');
    ...
    $sql = "SELECT * FROM tblbooks";
        ...
        $query->execute();
        $resulttblb = $query->fetchAll(PDO::FETCH_ASSOC);
        
        $sql = "SELECT * FROM tblissuedbookdetails WHERE ReturnStatus=0";
		$query = $dbh->prepare($sql);
        $query->execute();
        $resulttblbd0 = $query->fetchAll(PDO::FETCH_ASSOC);

        $sql = "SELECT * FROM tblissuedbookdetails WHERE ReturnStatus=1";
		$query = $dbh->prepare($sql);
        $query->execute();
        $resulttblbd1 = $query->fetchAll(PDO::FETCH_ASSOC);

        $sql = "SELECT * FROM tblreaders";
		$query = $dbh->prepare($sql);
        $query->execute();
        $resulttblr = $query->fetchAll(PDO::FETCH_ASSOC);

        $sql = "SELECT * FROM tblauthors";
		$query = $dbh->prepare($sql);
        $query->execute();
        $resulttbla = $query->fetchAll(PDO::FETCH_ASSOC);

        $sql = "SELECT * FROM tblcategory";
		$query = $dbh->prepare($sql);
        $query->execute();
        $resulttblc = $query->fetchAll(PDO::FETCH_ASSOC);
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-3 col-md-3">
          ...
          <div class="alert alert-succes text-center">
            <span class="fa fa-book fa-5x">
              <h3><?php echo count($resulttblb); ?></h3>
            </span>
            Nombre de livres
          </div>
        </div>
        <div class="col-sm-3 col-md-3">
          ...
          <div class="alert alert-succes text-center">
            <span class="fa fa-book fa-5x">
              <h3><?php echo count($resulttblbd0); ?></h3>
        ...
        <div class="col-sm-3 col-md-3">
          ...
          <div class="alert alert-succes text-center">
            <span class="fa fa-bars fa-5x">
              <h3><?php echo count($resulttblbd1); ?></h3>
        ...
        <div class="col-sm-3 col-md-3">
          ...
          <div class="alert alert-succes text-center">
            <span class="fa fa-recycle fa-5x">
              <h3><?php echo count($resulttblr); ?></h3>
        ...
        <div class="col-sm-3 col-md-3">
          ...
          <div class="alert alert-succes text-center">
            <span class="fa fa-users fa-5x">
              <h3><?php echo count($resulttbla); ?></h3>
        ...
        <div class="col-sm-3 col-md-3">
          ...
          <div class="alert alert-succes text-center">
            <span class="fa fa-file-archive fa-5x">
              <h3><?php echo count($resulttblc); ?></h3>
